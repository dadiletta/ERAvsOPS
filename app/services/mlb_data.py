...
class MLBDataFetcher:
    ...
    def get_all_team_stats(self, season=None):
        ...
        if season is None:
            ...
            if self.api_available:
                try:
                    ...
                    season = season_info.get('seasonId', datetime.now().year)
                except:
        ...
        if self.api_available:
            team_stats = self._get_stats_from_statsapi(season)
            if team_stats:
    ...
    def _get_stats_from_statsapi(self, season):
        ...
        try:
            ...
            for team in teams:
                ...
                try:
                    current_app.logger.info(f"Getting stats for {team_name}...")
                    ...
                    if era is not None and ops is not None:
                        ...
                        current_app.logger.info(f"  Added {team_name}: ERA={era}, OPS={ops}")
                    else:
    ...
    def _get_fallback_stats(self):
        ...
        return [
            ...
            # Add the rest of your hardcoded teams here...
    ...
    def _get_stats_from_statsapi(self, season, progress_callback=None):
        ...
        try:
            ...
            current_app.logger.info(f"Starting to fetch stats for {total_teams} MLB teams")
